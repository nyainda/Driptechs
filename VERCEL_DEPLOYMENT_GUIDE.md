...
The deployment is configured through `vercel.json`. No manual configuration needed in the dashboard. The configuration handles:
- API functions through the `/api` directory
