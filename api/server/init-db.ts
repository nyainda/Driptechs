...
import { db } from './db';
import { users, products, blogPosts, projects, successStories, teamMembers } from '../shared/schema.js';
    ...
    const demoSuccessStories = [
      {
        ...
        waterSavings: '55%',
        yieldIncrease: '75%',
        testimonial: 'DripTech transformed my farm completely. The water savings and increased yields have made my farming business profitable.',
      ...
      },
      {
        ...
        clientName: 'Kibera Women\'s Group',
        ...
        waterSavings: '65%',
        yieldIncrease: '80%',
        testimonial: 'Our community garden now feeds 50 families thanks to DripTech\'s efficient irrigation system.',
        image: '/api/placeholder/600/400',
